...
public class CDPCredentialsProvider{
    ...
    private static final Logger LOG = LoggerFactory.getLogger(CDPCredentialsProvider.class);

    public CDPCredentialsProvider() throws Exception {
        this(null, new Configuration());
    }

    public CDPCredentialsProvider(URI uri, Configuration conf) throws Exception {
    ...
    public void setEcsObsCredentialsProvider(EcsObsCredentialsProvider ecsObsCredentialsProvider) {
        CDPCredentialsProvider.ecsObsCredentialsProvider = ecsObsCredentialsProvider;
    }
