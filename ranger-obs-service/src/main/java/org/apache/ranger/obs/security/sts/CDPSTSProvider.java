 ...
 */
public class CDPSTSProvider implements STSProvider {

    CDPCredentialsProvider credentialsProvider;

    @Override
    public void init(Configuration configuration) throws Exception {
        credentialsProvider = new CDPCredentialsProvider(null,configuration);
    }
